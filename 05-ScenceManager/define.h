...
#define MARIO_ANI_TALE_IDLE_LEFT	15
#define MARIO_ANI_TALE_IDLE_RIGHT	16
#define MARIO_ANI_TALE_WALK_LEFT	17
#define MARIO_ANI_TALE_WALK_RIGHT	18

#define	MARIO_LEVEL_SMALL	1
#define	MARIO_LEVEL_BIG		2
#define MARIO_LEVEL_TALE	3
